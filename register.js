...
$(document).ready(function() {
  ...
  document.querySelector(".loader").style.position = "absolute";
    ...
    const links = ["./photoss/The Ultimate Gift for Your Soulmate_ Custom Sketches from SoulMate Sketch.jfif","./photoss/_Lee Chong Wei - Badminton_ Poster for Sale by RobSpink.jfif","./photoss/Messi and Ronaldo Football iPhone Wallpaper _ Ronaldo football, Messi and ronaldo, Cristiano ronaldo junior.jfif","./photoss/For the vinyl curious_ Pioneer PL-30-K turntable.jfif","./photoss/d063397a-aa66-444c-aa0f-15c983fa6718.jfif","./photoss/_Table Tennis Background_ by Stocksy Contributor _Urs Siedentop & Co_.jfif","https://i.pinimg.com/564x/88/2a/a4/882aa40a27b566089d6fc8f0d8f2e0ac.jpg","./photoss/9bfb1ed2-3d3d-4db9-97aa-6bbe0930f446.jfif"];
